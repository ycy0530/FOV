// FOV questionnaire — 10 questions, 4 graded options each (V2).
...
export const QUESTIONS = [
  {
    ...
    options: [
      ...
      { text: 'I lean cautious, but can accept small risks', f: 1, v: 0, tag: 'You lean cautious with your finances' },
      { text: 'I can handle moderate ups and downs', f: 0, v: 1, tag: 'You can tolerate moderate uncertainty' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Uneasy — I'd rather it stayed put", f: 1, v: 0, tag: 'You would rather your payment stayed predictable' },
      { text: "Mostly fine — I'd adapt within reason", f: 0, v: 1, tag: 'You could manage reasonable payment movement' },
      { text: "Completely fine — I'd adjust as needed", f: 0, v: 2, tag: "Payment changes wouldn't bother you" },
    ],
  },
  {
    id: 'knowledge',
    ...
    options: [
      { text: "Brand new — it's mostly unfamiliar to me", f: 1, v: 0, tag: "You're newer to how rates work, so simplicity helps" },
      { text: 'I know the basics', f: 0, v: 0, tag: 'You understand the basics of fixed vs variable' },
      { text: 'Fairly comfortable — I understand prime and terms', f: 0, v: 1, tag: 'You understand how variable rates move with prime' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: '5 to 10 years', f: 1, v: 0, tag: 'A longer hold can suit locked-in payment stability' },
      { text: 'More than 10 years — this is long-term', f: 2, v: 0, tag: 'A long-term hold pairs well with locked-in stability' },
    ],
  },
  {
    id: 'income',
    ...
    options: [
      ...
      { text: 'Stable — steady salary or wages', f: 0, v: 1, tag: 'Stable income gives you room to absorb rate movement' },
      { text: 'Very stable — two incomes, pension, or long tenure', f: 0, v: 2, tag: 'Very stable income gives you strong capacity to absorb rate swings' },
    ],
  },
  {
    id: 'cashflow',
    ...
    options: [
      ...
      { text: 'Tight — it would mean real cutbacks', f: 1, v: 0, tag: 'Limited budget room favours a payment that cannot rise' },
      { text: 'Okay — some room to absorb it', f: 0, v: 1, tag: 'You have a reasonable cushion in your budget' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Not much — I'd keep an eye on it", f: 0, v: 1, tag: 'Rate increases would not rattle you much' },
      { text: "Not at all — I'd ride it out", f: 0, v: 2, tag: "Rising rates wouldn't shake you" },
    ],
  },
  {
    id: 'rates_falling',
    ...
    options: [
      { text: "Strongly — I'd want to benefit when they drop", f: 0, v: 2, tag: 'You expect rates to fall and want to capture that' },
      { text: 'Somewhat — a drop seems more likely than not', f: 0, v: 1, tag: 'You lean toward rates drifting lower' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Lean savings, but I want some stability', f: 0, v: 1, tag: 'You lean toward savings while valuing some stability' },
  ...
  },
  {
    ...
    options: [
      { text: 'Very likely — life or plans may change', f: 0, v: 2, tag: 'Variable penalties (3 months interest) are usually far lower if you break early' },
      { text: 'Possibly — hard to say', f: 0, v: 1, tag: 'Flexibility has value if your plans might change' },
      { text: "Unlikely — I expect to see the term through", f: 1, v: 0, tag: "You're likely to hold the full term" },
      { text: "Definitely not — I'm locked into my plans", f: 2, v: 0, tag: 'Holding the full term removes the penalty advantage of variable' },
    ],
  },
];
